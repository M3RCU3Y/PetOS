...
function drawCatEffects(c:CanvasRenderingContext2D,p:PetState,pos:Vec2,t:number,scene:RenderScene):void{
  ...
  if(p.behavior==="startle"&&t-p.behaviorSinceMs<900){c.globalAlpha=1-(t-p.behaviorSinceMs)/900;c.fillStyle="#ffd76e";c.font="bold 14px ui-monospace,monospace";c.textAlign="center";c.fillText("!",pos.x+p.body.facing*13,pos.y-mv.bodyHeight-18);c.globalAlpha=1;}
