...
export const BUILTIN_PACKS:PetPack[]=[
  {id:"cat-orange",name:"Orange Tabby",version:"1.0.0",species:"cat",author:"PetOS",description:"Curious, energetic orange cat.",appearance:{coat:"#d77b36",accent:"#f2bf7d",eye:"#d9ef73",scale:1,markings:"tabby"},personality:{curiosity:.92,playfulness:.88,energy:.68},tags:["cat","orange","starter"]},
  {id:"cat-tuxedo",name:"Tuxedo Cat",version:"1.0.0",species:"cat",author:"PetOS",description:"Confident black-and-white cat.",appearance:{coat:"#25252d",accent:"#f0ede5",eye:"#8bd6a1",scale:1,markings:"tuxedo"},personality:{boldness:.72,affection:.7},tags:["cat","tuxedo"]},
  {id:"cat-colorpoint",name:"Fluffy Colorpoint",version:"1.0.0",species:"cat",author:"PetOS",description:"Gentle cream cat with cocoa points and bright blue eyes.",appearance:{coat:"#eadfc8",accent:"#705447",eye:"#70b9e8",scale:1,markings:"patched"},personality:{affection:.82,patience:.74,energy:.48},tags:["cat","colorpoint","fluffy"]},
  ...
  {id:"cat-pixel",name:"Cozy Procedural Cat",version:"2.0.0",species:"cat",author:"PetOS",description:"Live code-drawn cozy cat with individual anatomy, markings and behavior-driven animation.",appearance:{coat:"#d78a4f",accent:"#f2d1a3",eye:"#a7c96b",scale:1,markings:"tabby"},personality:{curiosity:.78,playfulness:.72,affection:.68},tags:["generated","procedural","illustrated","cat","cozy"]},
